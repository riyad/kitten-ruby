...
UI_DIR = ./kitten/ui
UI = clone_repository_dialog commit_widget commit_info_widget compare_widget file_status_widget history_widget main_window repositories_dialog stage_widget
